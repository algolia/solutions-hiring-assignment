...
- Using the [Algolia JS Helper](https://github.com/algolia/algoliasearch-helper-js) (and not instantsearch.js), implement an as-you-type search experience that enables users to easily find restaurants: both by passing a search query and/or filtering on the &ldquo;type of cuisine&rdquo;

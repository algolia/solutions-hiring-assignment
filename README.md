...
- Leverage the user&rsquo;s location to show restaurants closer to them higher in the results&mdash;use the location mechanism that will give them the most fine-grained results
